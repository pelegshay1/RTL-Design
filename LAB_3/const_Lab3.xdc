...
set_property -dict { PACKAGE_PIN R17 IOSTANDARD LVCMOS33 } [get_ports { num[4] }]; 
set_property -dict { PACKAGE_PIN T18 IOSTANDARD LVCMOS33 } [get_ports { num[5] }]; 
set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33 } [get_ports { num[6] }]; 
set_property -dict { PACKAGE_PIN R13 IOSTANDARD LVCMOS33 } [get_ports { num[7] }]; 
set_property -dict { PACKAGE_PIN T8 IOSTANDARD LVCMOS18 } [get_ports { num[8] }]; 
set_property -dict { PACKAGE_PIN U8 IOSTANDARD LVCMOS18 } [get_ports { num[9] }]; 
set_property -dict { PACKAGE_PIN R16 IOSTANDARD LVCMOS33 } [get_ports { num[10] }]; 
set_property -dict { PACKAGE_PIN T13 IOSTANDARD LVCMOS33 } [get_ports { num[11] }]; 
set_property -dict { PACKAGE_PIN H6 IOSTANDARD LVCMOS33 } [get_ports { num[12] }]; 
set_property -dict { PACKAGE_PIN U12 IOSTANDARD LVCMOS33 } [get_ports { num[13] }]; 
set_property -dict { PACKAGE_PIN U11 IOSTANDARD LVCMOS33 } [get_ports { num[14] }]; 
set_property -dict { PACKAGE_PIN V10 IOSTANDARD LVCMOS33 } [get_ports { num[15] }];
...
##7 segment display
## 7 segment display (Segments: a-g / Cathodes)
# The order is: 7'b A(6) B(5) C(4) D(3) E(2) F(1) G(0)
set_property -dict { PACKAGE_PIN T10  IOSTANDARD LVCMOS33 } [get_ports { seg_catode[6] }]; # Sch=A
set_property -dict { PACKAGE_PIN R10  IOSTANDARD LVCMOS33 } [get_ports { seg_catode[5] }]; # Sch=B
set_property -dict { PACKAGE_PIN K16  IOSTANDARD LVCMOS33 } [get_ports { seg_catode[4] }]; # Sch=C
set_property -dict { PACKAGE_PIN K13  IOSTANDARD LVCMOS33 } [get_ports { seg_catode[3] }]; # Sch=D
set_property -dict { PACKAGE_PIN P15  IOSTANDARD LVCMOS33 } [get_ports { seg_catode[2] }]; # Sch=E
set_property -dict { PACKAGE_PIN T11  IOSTANDARD LVCMOS33 } [get_ports { seg_catode[1] }]; # Sch=F
set_property -dict { PACKAGE_PIN L18  IOSTANDARD LVCMOS33 } [get_ports { seg_catode[0] }]; # Sch=G

#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { DP }]; #IO_L19N_T3_A21_VREF_15 Sch=dp


## 7 segment display (Digit Select: AN0-AN4 / Anodes)
# We only use the first 5 digits (AN0 to AN4)
set_property -dict { PACKAGE_PIN J17  IOSTANDARD LVCMOS33 } [get_ports { seg_anode[0] }]; # Sch=AN[0]
set_property -dict { PACKAGE_PIN J18  IOSTANDARD LVCMOS33 } [get_ports { seg_anode[1] }]; # Sch=AN[1]
set_property -dict { PACKAGE_PIN T9   IOSTANDARD LVCMOS33 } [get_ports { seg_anode[2] }]; # Sch=AN[2]
set_property -dict { PACKAGE_PIN J14  IOSTANDARD LVCMOS33 } [get_ports { seg_anode[3] }]; # Sch=AN[3]
set_property -dict { PACKAGE_PIN P14  IOSTANDARD LVCMOS33 } [get_ports { seg_anode[4] }]; # Sch=AN[4]
...
##Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { center_button }]; #IO_L9P_T1_DQS_14 Sch=btnc
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { BTNU }]; #IO_L4N_T0_D05_14 Sch=btnu
#set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { BTNL }]; #IO_L12P_T1_MRCC_14 Sch=btnl
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { BTNR }]; #IO_L10N_T1_D15_14 Sch=btnr
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { down_button }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
